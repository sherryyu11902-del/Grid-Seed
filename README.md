...
| **Panel UI (GitHub Pages)** · **插件面板（在线）** | [https://sherryyu11902-del.github.io/Grid-Seed/](https://sherryyu11902-del.github.io/Grid-Seed/)（或 [`…/index.html`](https://sherryyu11902-del.github.io/Grid-Seed/index.html)） |
...
**为何不要用 `…/插件分支文件/index.html` 做 Pages 链接：** GitHub Pages 实际可用的面板入口在**站点根**（`/Grid-Seed/`）。带 **`插件分支文件/`** 且含**中文路径** 的 URL 在静态站点上常会返回 **404**（与仓库里源码目录结构不完全等同）；开发源码仍在 `插件分支文件/` 内，但对外分享请用根路径。
...
| Page · 页面 | URL |
|-------------|-----|
| 插件面板（站点根，勿用中文子路径） | [https://sherryyu11902-del.github.io/Grid-Seed/](https://sherryyu11902-del.github.io/Grid-Seed/) · [index.html](https://sherryyu11902-del.github.io/Grid-Seed/index.html) |
